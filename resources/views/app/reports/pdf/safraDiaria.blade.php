...
<body>
    @php
        $nombreImagen = '../public/storage/images/Cintillo.jpg';
        $imagenBase64 = "data:image/png;base64," . base64_encode(file_get_contents($nombreImagen));

        $nombreImagen2 = '../public/storage/images/Sitssa.jpg';
        $imagen2Base64 = "data:image/png;base64," . base64_encode(file_get_contents($nombreImagen2));
    @endphp

    <img src="{{ $imagenBase64 }}" alt="Cintillo" width="100%" height="50">
    <img src="{{ $imagen2Base64 }}" alt="Cintillo" width="40%" height="50" style="float:right; margin-right:20%; margin-top:-4.33%">
    <br/>
    <br/>
    <br/>
    ...
    <table class="minimalistBlack">
        ...
        <tbody>
            ...
            @foreach ($reports as $report)
                @php
                    $total_mov_ida = $total_mov_ida + $report['cant_ida'];
                    $total_mov_ret = $total_mov_ret + $report['cant_return'];
                ...
                <tr>
                    <td>{{ $i }}</td>
                    <td>{{ $report['nu_unidad'] }}</td>
                    <td>{{ $report['cant_ida'] }}</td>
                    <td>{{ $report['cant_return'] }}</td>
